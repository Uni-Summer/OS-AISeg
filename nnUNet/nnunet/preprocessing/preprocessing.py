...
def resample_patient(data, seg, original_spacing, target_spacing, order_data=3, order_seg=0, force_separate_z=False,
    ...
    # nnUNet设定的判断标准是，中值spacing中三个维度，是否有一个维度spacing大于另一个维度spacing的3倍，def get_do_separate_z
...
class GenericPreprocessor(object):
    def __init__(self, normalization_scheme_per_modality, use_nonzero_mask, transpose_forward, intensityproperties=None):
        ...
        self.normalization_scheme_per_modality = normalization_scheme_per_modality# 0:'CT'
        self.use_nonzero_mask = use_nonzero_mask# 0:False
    ...
    def resample_and_normalize(self, data, target_spacing, properties, seg=None, force_separate_z=None):
        ...
        for c in range(len(data)):
            ...
            if scheme == "CT":
                ...
                # z-scoring(即减去均值除以标准差)
                data[c] = (data[c] - mean_intensity) / std_intensity
                if use_nonzero_mask[c]:
                    print('use_nonzero_mask in 3d generic preprocessor...')
                    data[c][seg[-1] < 0] = 0
            elif scheme == "CT2":
    ...
    def run(self, target_spacings, input_folder_with_cropped_npz, output_folder, data_identifier,
        ...
        print("npz folder:", input_folder_with_cropped_npz)#folder_with_cropped_data
        print("output_folder:", output_folder)#preprocessed_output_folder
        ...
        for i in range(num_stages):
            ...
            for j, case in enumerate(list_of_cropped_npz_files):
                case_identifier = get_case_identifier_from_npz(case)#stroke_001
