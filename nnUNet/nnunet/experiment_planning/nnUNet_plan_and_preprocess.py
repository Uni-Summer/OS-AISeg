...
def main():
    ...
    parser.add_argument("-t", "--task_ids", nargs="+", default=[800],
    ...
    for i in task_ids:
        ...
        task_name = convert_id_to_task_name(i)#'Task800_Stroke'
    ...
    #'/home/summer/anaconda3/lib/python3.8/site-packages/nnunet/experiment_planning'
    ...
    for t in tasks:
        ...
        if planner_3d is not None:#class ExperimentPlanner3D_v21
            if args.overwrite_plans is not None:
        ...
        if planner_2d is not None:#ExperimentPlanner2D_v21
